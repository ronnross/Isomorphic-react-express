	  ...
	  render: function() {
	    ...
	    return (
	      React.createElement("div", null, 
	        "Hello World Element ", React.createElement("br", null), 
	        "Called from - ", this.state.caller, " ", React.createElement("br", null), 
	        React.createElement("button", {onClick: this.handleClick}, 
	          "This switch is ", React.createElement("b", null, " ", text, " "), ". Click to toggle."
	        )
	      )
	    );
	  }
